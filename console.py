...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        """Create new class instance and prints id
        Usage: create <class>
        """
        argl = parse(arg)
        if len(argl) == 0:
    ...
    def do_show(self, arg):
        """Displays string representation of a class instance of a given id.
    ...
    def do_all(self, arg):
        """Displays tring representations of all instances of a given class.
